...
Como compatibilidade temporária, instalações que ainda possuem `JWT_SECRET` com ao menos 32 caracteres derivam dela uma chave AES-256. Migre para `TOKEN_ENCRYPTION_KEY` antes da próxima rotação de segredos.
